...
class XORGate(Scene):
    def construct(self):
        ...
        xor_gate = Group(gate, arcs[3]).center()

        dot0, dot1, dot2, dot3, dot4, dot5 = Dot([-0.5, -0.55, 0]), Dot(bits[0]), Dot([0.5, -0.55, 0]), Dot(bits[1]), Dot([0, 1, 0]), Dot(bits[2])
        ...
        g1 = Group(l0, l1, l2)
        g2 = Group(g0, g1, xor_gate).shift(RIGHT * 3)
